...
const routes = [
  {
    ...
    children: [
...

      {
        ...
        children: [
          { path: 'plan', component: () => import('@/views/openPolicy/Plan.vue'), meta: { title: '政策相關' } },
          { path: 'law-change', component: () => import('@/views/openPolicy/LawChange.vue'), meta: { title: '年度經費' } },
          { path: 'promotion', component: () => import('@/views/openPolicy/Promotion.vue'), meta: { title: '資訊公開' } },
          { path: 'lobby', component: () => import('@/views/openPolicy/Lobby.vue'), meta: { title: '廉政圖地' } },
...

      {
        ...
        children: [
          { path: 'chair', component: () => import('@/views/council/Chair.vue'), meta: { title: '鄉民代表會' } },
          { path: 'org', component: () => import('@/views/council/Org.vue'), meta: { title: '出國考察報告' } },
          { path: 'contacts', component: () => import('@/views/council/Contacts.vue'), meta: { title: '代表會活動' } },
          { path: 'law-announce', component: () => import('@/views/council/LawAnnounce.vue'), meta: { title: '會議資訊' } },
...

      {
        ...
        children: [
          ...
          { path: 'categories', component: () => import('@/views/system/Categories.vue'), meta: { title: '推播設定' } },
