...
const ROUTE_OPTIONS = [
  ...
  // 資訊公開與政策
  { label: "資訊公開與政策 / 工程類", path: "/open-policy/engineering" },
  { label: "資訊公開與政策 / 經費類", path: "/open-policy/budget" },
  { label: "資訊公開與政策 / 廉政類", path: "/open-policy/integrity" },
  { label: "資訊公開與政策 / 法治類", path: "/open-policy/law" },
  { label: "資訊公開與政策 / 施政計畫", path: "/open-policy/plan" },
  { label: "資訊公開與政策 / 法規增修", path: "/open-policy/law-change" },
  { label: "資訊公開與政策 / 政策宣導", path: "/open-policy/promotion" },
  { label: "資訊公開與政策 / 遊說法專區", path: "/open-policy/lobby" },
  { label: "資訊公開與政策 / 年度經費", path: "/open-policy/year-budget" },
  { label: "資訊公開與政策 / 核定計畫專區", path: "/open-policy/approved" },
  { label: "資訊公開與政策 / 重大計畫", path: "/open-policy/major" },
  ...
  // 代表會
  { label: "代表會專區 / 主席介紹", path: "/council/chair" },
  { label: "代表會專區 / 組織介紹/架構", path: "/council/org" },
  { label: "代表會專區 / 代表服務電話", path: "/council/contacts" },
  { label: "代表會專區 / 法規公告宣導", path: "/council/law-announce" },
  ...
  { label: "系統管理 / 分類與標籤", path: "/system/categories" },
...
const DEFAULT_TREE = [
  ...
  },
  {
    ...
    externalBlank: true,
    children: [
      nodeRoute("工程類", "/open-policy/engineering"),
      nodeRoute("經費類", "/open-policy/budget"),
      nodeRoute("廉政類", "/open-policy/integrity"),
      nodeRoute("法治類", "/open-policy/law"),
      nodeRoute("施政計畫", "/open-policy/plan"),
      nodeRoute("法規增修", "/open-policy/law-change"),
      nodeRoute("政策宣導", "/open-policy/promotion"),
      nodeRoute("遊說法專區", "/open-policy/lobby"),
  ...
  },
  {
    ...
    externalBlank: true,
    children: [
      nodeRoute("主席介紹", "/council/chair"),
      nodeRoute("組織介紹/架構", "/council/org"),
      nodeRoute("代表服務電話", "/council/contacts"),
      nodeRoute("法規公告宣導", "/council/law-announce"),
  ...
  },
  {
    ...
    children: [
      ...
      nodeRoute("分類與標籤", "/system/categories"),
